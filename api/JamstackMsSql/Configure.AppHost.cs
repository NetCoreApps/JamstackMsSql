using Funq;
using ServiceStack;
using JamstackMsSql.ServiceInterface;

[assembly: HostingStartup(typeof(JamstackMsSql.AppHost))]

namespace JamstackMsSql;
...
public class AppHost : AppHostBase, IHostingStartup
{
    ...
    public AppHost() : base("JamstackMsSql", typeof(MyServices).Assembly) {}
